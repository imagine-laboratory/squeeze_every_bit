...
def intersection(boxes_preds, boxes_labels, box_format="corners"):
    """
    ...
    return (intersection / (box2_area + 1e-6), (box1_area + 1e-6))
    # return (intersection / (box1_area + box2_area - intersection + 1e-6), (box1_area + 1e-6))